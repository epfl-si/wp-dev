...
1. Install and activate the EPFL theme with the commands:  
   `wp theme install wp-theme-2018`  
   `wp theme activate wp-theme-2018`
1. Browse the site: you should have the EPFL theme in place, and a “raw” WordPress without plugins.
1. If needed, one can install plugins with the `wp plugin install/activate` command.
